...
Home'ISEP</h1>
  ...
  <h2>ARTICLE 1. INFORMATIONS LÉGALES</h2>
    <p>En vertu de l'article 6 de la Loi nḞ 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est précisé dans cet article l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi.
Le site Home'ISEP est édité par :
Domisep, dont le siège siège social est situé à l'adresse suivante : 10, rue de Vanves, 92130 Issy-les-Moulineaux, et immatriculée au registre suivant : ________.
Téléphone : 01 02 03 04 05/ Adresse e-mail : domisep@isep.fr.

Le directeur de publication du site est :
Monsieur Hervé Feller.

Le site Home'ISEP est hébergé par :
Domisep, dont le siège est situé 10, rue de Vanves, 92130 Issy-les-Moulineaux
Numéro de téléphone : 01 02 03 04 05</p>

  <h2>ARTICLE 2. PRÉSENTATION DU SITE</h2>
    <p>Le site Home'ISEP a pour objet :
L'enregistrement et la souscription aux services de Home'ISEP pour les particuliers,
La gestion des modules CEMAC, des capteurs et actionneurs associés par les particuliers,
L'accès aux données générées par les utilisateurs physiques de Home'ISEP.</p>

  <h2>ARTICLE 3. CONTACT</h2>
    <p>Pour toute question ou demande d'information concernant le site, ou tout signalement de contenu ou d'activités illicites, l'utilisateur peut contacter l'éditeur à l'adresse e-mail suivante: domisep@isep.fr ou adresser un courrier recommandé avec accusé de réception à : Domisep - 10, rue de Vanves, 92130 Issy-les-Moulineaux</p>

  <h2>ARTICLE 4. ACCEPTATION DES CONDITIONS D'UTILISATION</h2>
...
Il est donc conseillé à l'utilisateur de se référer avant toute navigation à la dernière version des CGU, accessible à tout moment sur le site. En cas de désaccord avec les CGU, aucun usage du site ne saurait être effectué par l'utilisateur.</p>

  <h2>ARTICLE 5. ACCÈS ET NAVIGATION</h2>
    <p>L'accès au site et son utilisation sont réservés aux personnes âgées au minimum de 18 ans. L'éditeur sera en droit de demander une justification de l'âge de l'utilisateur, et ce par tout moyen.
L'éditeur met en uvre les solutions techniques à sa disposition pour permettre l'accès au site 24 heures sur 24, 7 jours sur 7. Il pourra néanmoins à tout moment suspendre, limiter ou interrompre l'accès au site ou à certaines pages de celui-ci afin de procéder à des mises à jours, des modifications de son contenu ou tout autre action jugée nécessaire au bon fonctionnement du site.
La connexion et la navigation sur le site Home'ISEP valent acceptation sans réserve des présentes Conditions Générales d'Utilisation, quelques soient les moyens techniques d'accès et les terminaux utilisés.
...
- suspendre le site afin de procéder à des mises à jour.</p>
  ...
  <h2>ARTICLE 7. SERVICES RÉSERVÉS AUX UTILISATEURS INSCRITS</h2>
    <h3>7.1 INSCRIPTION</h3>
      <p>L'accès à certains services est conditionné par l'inscription de l'utilisateur.
L'inscription et l'accès aux services du site sont réservés exclusivement aux personnes physiques majeurs et capables juridiquement, ayant rempli et validé le formulaire d'inscription disponible en ligne sur le site Home'ISEP, ainsi que les présentes Conditions Générales d'Utilisation.
...
Toute communication réalisée par Home'ISEP et ses partenaires est en conséquence réputée avoir été réceptionnée et lue par l'utilisateur. Ce dernier s'engage donc à consulter régulièrement les messages reçus sur cette adresse e-mail et à répondre dans un délai raisonnable si cela est nécessaire.
...
Home'ISEP se réserve en tout état de cause la possibilité de refuser une demande d'inscription aux services en cas de non-respect par l'Utilisateur des dispositions des présentes Conditions Générales d'Utilisation.</p>

    <h3>7.2 DÉSINSCRIPTION</h3>
...
- des contenus ou activités illicites utilisant son site et ce, sans qu'il en ait pris dûment connaissance au sens de la Loi nḞ 0883-383 bb 01 abfb 0883 dcbf fc acbbfcbaa bcba f'aacbcafa bbaaffeba af fc Ecf bḞ0883-381 bb 3 ccbf 0883 fafcffea c fc dfcfaaffcb baa dafacbbaa dapafebaa à l'égard de traitement de données à caractère personnel.
...
- s'il ne respecte ni la lettre, ni l'esprit des présentes CGU.</p>
  ...
  <h2>ARTICLE 9. LIENS HYPERTEXTES</h2>
    <p>Le site peut contenir des liens hypertextes pointant vers d'autres sites internet sur lesquels Home'ISEP n'exerce pas de contrôle. Malgré les vérifications préalables et régulières réalisés par l'éditeur, celui-ci décline tout responsabilité quant aux contenus qu'il est possible de trouver sur ces sites.
...
Enfin, Home'ISEP se réserve le droit de faire supprimer à tout moment un lien hypertexte pointant vers son site, si le site l'estime non conforme à sa politique éditoriale.</p>

  <h2>ARTICLE 10. COLLECTE DE DONNÉES</h2>
...
Il est interdit à l'utilisateur d'introduire des données sur le site qui modifieraient ou qui seraient susceptibles d'en modifier le contenu ou l'apparence.</p>
  ...
  <p>Le site Home'ISEP vous souhaite une excellente navigation !</p>
